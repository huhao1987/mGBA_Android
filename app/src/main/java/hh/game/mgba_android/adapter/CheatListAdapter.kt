...
class CheatListAdapter(var context: Context, var list: ArrayList<Cheat>) :
    RecyclerView.Adapter<CheatListAdapter.ViewHolder>() {
...
typealias CheatOnCheckListener = (Int,Boolean) -> Unit